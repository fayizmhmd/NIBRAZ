...
@endsection
@section('content')
<form action="{{ route('admin.savePrograms') }}" method="POST" id="myForm" enctype="multipart/form-data">
    @csrf
        ...
        <div class='form-group row mb-4 align-middle'>
            ...
            <div class="col-lg-9">
                <input type="text" class="form-control" value="" placeholder="Duration...!" name='duration'
                    required />
            </div>
        </div>
